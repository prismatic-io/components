<div align="center">
  ...
  <h1>Prismatic Components</h1>
</div>

Prismatic Components makes our pre-built third-party components (also called connectors) available publicly under an Apache 2.0 license.

The intent behind making these available is that our customers can leverage these components as a baseline for their own custom components and refer to them as functional examples beyond [the official documentation](https://prismatic.io/docs).
