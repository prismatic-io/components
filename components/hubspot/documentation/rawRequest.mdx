...
This is especially helpful for [search](https://developers.hubspot.com/docs/api-reference/latest/crm/search-the-crm) endpoints, where objects may have custom properties that are unique to your customers.
