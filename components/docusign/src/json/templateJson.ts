    ...
    signers: [
      {
          ...
          signHereTabs: [
            {
              ...
              tabGroupLabels: ["sample string 1"],
            },
          ],
          initialHereTabs: [
            {
          ...
          formulaTabs: [
            {
              ...
              paymentDetails: {
                ...
                allowedPaymentMethods: ["sample string 1"],
        ...
        excludedDocuments: ["sample string 1"],
        ...
        phoneAuthentication: {
          ...
          senderProvidedNumbers: ["sample string 1"],
        },
        samlAuthentication: {
