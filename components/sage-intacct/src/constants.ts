...
export const OBJECT_AP_BILL = "APBILL";
export const OBJECT_AP_PAYMENT = "APPYMT";
export const OBJECT_AR_ADJUSTMENT = "ARADJUSTMENT";
export const OBJECT_AR_ADJUSTMENT_ITEM = "ARADJUSTMENTITEM";
export const OBJECT_AR_ADVANCE = "ARADVANCE";
export const OBJECT_AR_INVOICE = "ARINVOICE";
export const OBJECT_AR_PAYMENT = "ARPYMT";
export const OBJECT_CONTACT = "CONTACT";
export const OBJECT_CUSTOMER = "CUSTOMER";
export const OBJECT_EMPLOYEE = "EMPLOYEE";
export const OBJECT_PROJECT = "PROJECT";
export const OBJECT_VENDOR = "VENDOR";
...
> = {
  vendors: {
    objectName: OBJECT_VENDOR,
    timestampField: "WHENMODIFIED",
    createdField: "WHENCREATED",
    label: "Vendors",
  },
  customers: {
    objectName: OBJECT_CUSTOMER,
    timestampField: "WHENMODIFIED",
    createdField: "WHENCREATED",
    label: "Customers",
  },
  bills: {
    objectName: OBJECT_AP_BILL,
    timestampField: "WHENMODIFIED",
    createdField: "WHENCREATED",
    label: "Bills (AP)",
  },
  invoices: {
    objectName: OBJECT_AR_INVOICE,
    timestampField: "WHENMODIFIED",
    createdField: "WHENCREATED",
    label: "Invoices (AR)",
  },
  ...
  employees: {
    objectName: OBJECT_EMPLOYEE,
    timestampField: "WHENMODIFIED",
    createdField: "WHENCREATED",
    label: "Employees",
  },
  projects: {
    objectName: OBJECT_PROJECT,
    timestampField: "WHENMODIFIED",
    createdField: "WHENCREATED",
    label: "Projects",
  },
  arPayments: {
    objectName: OBJECT_AR_PAYMENT,
    timestampField: "WHENMODIFIED",
    createdField: "WHENCREATED",
    label: "AR Payments",
  },
