...
const createOnboardingRequestAdditionalFields = structuredObjectInput({
  label: "Additional Fields",
  comments:
    "Additional optional fields: includes Assets, Location, Hierarchy, and Verified.",
  inputs: {
    cfAssets,
    cfLocation,
    cfHierarchy,
...
export const createOnboardingRequestInputs = {
  ...
  cfAllUsers,
  cfDepartment,
  additionalFields: createOnboardingRequestAdditionalFields,
