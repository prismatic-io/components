  ...
  properties: {
              ...
              parent: {
                ...
                properties: {
                  invoice_item_details: {
                    ...
                    required: ["invoice_item", "proration"],
                  },
                  subscription_item_details: {
                    ...
                    required: ["proration", "subscription_item"],
                  },
                  type: {
                    type: "string",
    ...
    total_taxes: {
      ...
      items: {
        ...
        required: ["amount", "tax_behavior", "taxability_reason", "type"],
      },
    },
...
export const listInvoicesOutputSchema = {
  type: "object" as const,
  properties: {
    object: { type: "string", enum: ["list"] },
    data: { type: "array", items: invoiceOutputSchema },
    has_more: { type: "boolean" },
    url: { type: "string" },
  },
  required: ["object", "data", "has_more", "url"],
};
export const deleteInvoiceOutputSchema = {
  type: "object" as const,
  properties: {
    deleted: {
      type: "boolean",
