...
export const executeStatement = action({
  ...
  perform: async (
    ...
    const commandInput: ExecuteStatementCommandInput = {
      ...
      StatementName: additionalFields.statementName,
      DbUser: databaseUser,
      SecretArn: secretArn,
      Parameters: sqlParameters,
      ResultFormat: additionalFields.resultFormat,
      SessionId: additionalFields.sessionId,
      SessionKeepAliveSeconds: additionalFields.sessionKeepAliveSeconds,
      ClientToken: additionalFields.clientToken,
