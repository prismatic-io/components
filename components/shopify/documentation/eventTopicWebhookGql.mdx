...
- **Secret Key**: The Shopify app's client secret for HMAC signature verification, viewable from the app's Configuration section in the [Shopify Partner Dashboard](https://www.shopify.com/partners)
...
A complete list of webhook topics and their payloads is available in the [Shopify Webhook Topics documentation](https://shopify.dev/docs/api/webhooks/latest).
